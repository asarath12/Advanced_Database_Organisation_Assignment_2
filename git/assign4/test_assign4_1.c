...
{
  printf("log entry:testInsertAndFind method \n");
  RID insert[] = { 
    {1,1},
    {2,3},
    {1,2},
  ...
  TEST_DONE();
  printf("log exit:testInsertAndFind method \n");
}
...
testDelete (void)
{
  printf("log entry:testDelete method \n");
  RID insert[] = { 
    {1,1},
    {2,3},
    {1,2},
  ...
  TEST_DONE();
  printf("log exit:testDelete method \n");
}
...
testIndexScan (void)
{
  printf("log entry:testIndexScan method \n");
  RID insert[] = { 
    {1,1},
    {2,3},
    {1,2},
  ...
  TEST_DONE();
  printf("log exit:testIndexScan method \n");
}
