...
{
    //printf("logEntry createPageFile method \n");
...
extern RC openPageFile(char *fileName, SM_FileHandle *fHandle)
{
    ...
    else
    {
        ...
        if (sizeOfFile == negOne)
        {
            return RC_ERROR;
        }

        int tot_num_pages = sizeOfFile / PAGE_SIZE;
        ...
        fHandle->totalNumPages = tot_num_pages * one;
...
{
    //printf("logEntry:destroyPageFile  \n");
...
{
    //printf("logEntry:readFirstBlock  \n");
    int zero=0;
    //int one=1;
    // Returns the first 
    //block from the disk
...
{
    //printf("logEntry:readPreviousBlock  \n");
    int one=1;
...
{
    //printf("logEntry:readCurrentBlock  \n");
...
{
    //printf("logEntry:writeCurrentBlock  \n");
...
{
    //printf("logEntry:appendEmptyBlock  \n");
    int zero=0;
    int one=1;
...
{
    //printf("logEntry:ensureCapacity  \n");
    int zero=0;
    //int one=1;
