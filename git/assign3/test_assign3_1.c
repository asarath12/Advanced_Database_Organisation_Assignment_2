...
testRecords (void)
{
	printf("log entry:testRecords function \n");
	TestRecord expected[] = {
			{1, "aaaa", 3},
	};
	Schema *schema;
	...
	freeRecord(r);
	TEST_DONE();
	printf("log exit:testRecords function \n");
}
...
{
	printf("log entry:testCreateTableAndInsert function \n");
	...
	free(table);
	TEST_DONE();
	printf("log exit:testCreateTableAndInsert function \n");
}

void
testMultipleScans(void)
{
	printf("log entry:testMultipleScans function \n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
	...
	free(table);
	TEST_DONE();
	printf("log exit:testMultipleScans function \n");
}

void 
testUpdateTable (void)
{
	printf("log entry:testUpdateTable function \n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
	...
	free(table);
	TEST_DONE();
	printf("log exit:testUpdateTable function \n");
}

void 
testInsertManyRecords(void)
{
	printf("log entry:testInsertManyRecords function \n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
	...
	free(table);
	TEST_DONE();
	printf("log exit:testInsertManyRecords function \n");
}

void testScans (void)
{
	printf("log entry:testScans function \n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
	...
	freeExpr(sel);
	TEST_DONE();
	printf("log exit:testScans function \n");
}


void testScansTwo (void)
{
	printf("log entry:testScansTwo function \n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
	...
	freeExpr(sel);
	TEST_DONE();
	printf("log exit:testScansTwo function \n");
}
...
testSchema (void)
{
	printf("log entry:testSchema function \n");
	Schema *result;
	char *names[] = { "a", "b", "c" };
	...
	printf("log exit:testSchema function \n");
	return result;
}
...
{
	//printf("log entry:fromTestRecord function \n");
...
{
	//printf("log entry:testRecord function \n");
	Record *result;
	Value *value;
